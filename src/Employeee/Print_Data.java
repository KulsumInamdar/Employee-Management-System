...
class Print_Data implements ActionListener{
    JFrame f;
    JLabel id8,id,aid,id1,aid1,id2,aid2,id3,aid3,id4,aid4,id5,aid5,id6,aid6,id7,aid7,id80,aid80,id9,id10,id11,id12,id13,id14,lab;
    String emp_id,name,father,address,phone,email,education,post,age,dob;
    JButton b1,b2;
    ImageIcon icon;
    ...
    Print_Data(String e_id){
        ...
        id80= new JLabel("DOB:");
        id80.setBounds(50,470,100,30);
        id80.setFont(new Font("serif",Font.BOLD,20));
        id9.add(id80);

        aid80= new JLabel(dob);
        aid80.setBounds(200,470,300,30); 
        aid80.setFont(new Font("serif",Font.BOLD,20));
        id9.add(aid80);
